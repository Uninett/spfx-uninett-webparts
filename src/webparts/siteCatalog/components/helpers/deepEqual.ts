// documentation https://github.com/substack/node-deep-equal


// node-deep-equal/lib/keys.js
function objectKeys(obj) {
  var keys: Array<string | never> = [];
...
var deepEqual = (actual: Array<any>, expected: Array<any>, opts?: { strict?: boolean }) => {
  if (!opts) opts = {};
