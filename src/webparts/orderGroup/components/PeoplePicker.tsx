...
import {
  ...
  IEnsureUser,
  IPeoplePickerState,
  SharePointUserPersona } from '../models/PeoplePicker';
//import { IPersonaWithMenu } from 'office-ui-fabric-react/lib/components/pickers/PeoplePicker/PeoplePickerItems/PeoplePickerItem.Props';
import * as strings from 'OrderGroupWebPartStrings';

const suggestionProps: IBasePickerSuggestionsProps = {
  suggestionsHeaderText: strings.SuggestedPeople,
  noResultsFoundText: strings.NoResultsFound,
...
export class PeoplePicker extends React.Component<IPeoplePickerProps, IPeoplePickerState> {
  ...
  private _filterPersonasByText(filterText: string): IPersonaProps[] {
    return this._peopleList.filter(item => this._doesTextStartWith(item.text, filterText));
  }
